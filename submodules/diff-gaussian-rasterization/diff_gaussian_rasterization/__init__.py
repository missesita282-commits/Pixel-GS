...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, radii, pixels, pixels_geo, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        ctx.save_for_backward(colors_precomp, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer, pixels_geo)
        return color, radii, pixels, pixels_geo

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, _, __):
